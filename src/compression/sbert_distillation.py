...
if __name__ == "__main__":
    ...
    if use_layer_reduction:
        ...
        if "distilbert" in teacher_model_name:
            ...
            auto_model.config.n_layers = len(layers_to_keep)
        else:
    ...
    train_data.add_dataset([[sent] for sent in train_sentences_nli], max_sentence_length=128)
