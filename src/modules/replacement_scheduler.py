...
class ConstantReplacementScheduler:
    def __init__(self, bert_encoder: Union[BertEncoder, Transformer], replacing_rate, replacing_steps=None):
...
class LinearReplacementScheduler:
    def __init__(self, bert_encoder: Union[BertEncoder, Transformer], base_replacing_rate, k):
        self.bert_encoder = bert_encoder
